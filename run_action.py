...
5.  Submits ONLY the abstracted code to the main /api/process_code endpoint.
...
def main():
    ...
    # --- FIX: Initialize redaction_data to prevent UnboundLocalError ---
    redaction_data = {}
    ...
    try:
        ...
        redaction_data = redact_res.json() # Assignment is now safe
